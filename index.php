...
<body>
    <div class="container">
        <h1 class="page-header text-center">Product Table</h1>
        <div class="row">
			...
			?>
                ...
                <div class="row">
                    <a href="#addnew" data-toggle="modal" class="btn btn-primary"><span
                            class="glyphicon glyphicon-plus"></span> New Product</a>
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>
										...
										<a href='#show_".$row['id']."'  class='btn btn-info btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-info-sign'></span> Show </a>
									</td>
								</tr>";
								include('View/edit_delete_modal.php');
